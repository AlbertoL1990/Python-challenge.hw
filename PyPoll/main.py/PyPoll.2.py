...
csvpath= os. path.join(r"C:\Users\A1990\Python-challege.hw\PyPoll\Resources", 'election_data.csv')
...
output_filepath = os.path.join(r"C:\Users\A1990\Python-challege.hw\PyPoll\analysis", 'analysis.txt')
